...
/**
 * Modella un percorso da un'origine ad una destinazione, entrambe modellate da
 * un oggetto {@link Coordinate} da parte di una generica bici, ad es. (ma non
 * solo!) di tipo {@link Bianca}
 */
