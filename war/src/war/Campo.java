...
public class Campo {
	...
	/**
	 * Restituisce l'insieme degli oggetti {@link Direzione} che possono essere
	 * seguite a partire dalla posizione passata come riferimento, oppure l'insieme
	 * vuoto se nessuna direzione e' possibile.<BR/>
	 * 
	...
	public Set<Direzione> getPossibiliDirezioni(Coordinate riferimento) {
		/*
		 * seleziona solo direzioni verso posizioni adiacenti al riferimento che non
		 * siano sul bordo
		 */
