...
/**
 * Questa classe modella un direzione (incrementale) sul piano cartesiano come
 * coppia di interi in {-1,0,+1}. <B>(DA COMPLETARE VEDI DOMANDA 1)</B>
 */
public class Direzione {
	...
	/*
	 * direzione di uno spostamento; un delta puo' essere -1 , 0 , +1
	 */
	private int dx;
	...
	/**
	 * Crea un oggetto {@link Direzione} per spostarsi da una posizione ad un'altra
	 * 
	 * @param src  posizione di partenza
	 * @param dest posizione di arrivo
	 */
	public Direzione(Coordinate src, Coordinate dest) {
		this(proiettaUnitariamente(dest.getX() - src.getX()), proiettaUnitariamente(dest.getY() - src.getY()));
	}
