...
/**
 * Modella le quattro fasi del ciclo di vita di un {@link Mezzo} ma lascia la
 * modellazione dei dettagli della fase di raccolta alle due classi
 * {@link Brown} e {@link Chase} fuori da questa classe. <B>(VEDI DOMANDA 2)</B>
 */
public class Mezzo {
	...
	/**
	 * Esegue una traslazione unitaria verso la posizione specificata, evitando di
	 * salire sul bordo della {@link Citta}
	 * 
	...
	public Posizione tentaSpostamentoVersoPosizione(Posizione obiettivo) {
		if (obiettivo == null)
			return this.getPosizione(); // don't move
	...
	/**
	 * Raccoglie un {@link Rifiuto} dalla {@link Posizione} corrente della
	 * {@link Citta}
	 * 
