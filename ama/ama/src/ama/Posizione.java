...
/**
 * Rappresenta una posizione, modellata come coppia di interi ascissa (x) ed
 * ordinata (y), all'interno della {@link Citta}. <B>(DA COMPLETARE VEDI DOMANDA
 * 1)</B>
 */
public class Posizione {
	...
	/**
	 * Crea un oggetto {@link Posizione} traslato rispetto all'originale. N.B. la
	 * traslazione è al massimo di una singola unità (+/-1) su ogni coordinata
	 * 
	 * @param dx - delta sull'ascissa della posizione corrente N.B. se positiva
	 *           trasla di +1, 0 se nulla, -1 altrimenit
	 * @param dy - delta sull'ordinata della posizione corrente N.B. se positiva
	 *           trasla di +1, 0 se nulla, -1 altrimenit
	 ...
	 * @return un nuovo oggetto {@link Posizione} traslato unitariamente verso
	 *         l'obiettivo
	 */
